...
class Board:
    def __init__(self, num_rows, num_cols):
        ...
        self._grid = {}
        self._hash = zobrish.EMPTY_BOARD

    # end::init_zobrist[]

    def place_stone(self, player, point):
        """
        Place stone into board
        :param player:
        :param point:
        :return:
        """
        ...
        self._hash ^= zobrish.HASH_CODE[point, player]  # <3>
    ...
    def _remove_string(self, string):
        ...
        for point in string.stones:
            ...
            self._hash ^= zobrish.HASH_CODE[point, string.color]  # <3>
